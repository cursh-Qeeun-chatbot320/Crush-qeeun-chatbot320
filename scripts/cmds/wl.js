...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			added: "🫶 | Added 🐼cxly🌺 whiteList role for %1 users:\n%2",

			alreadyAdmin: "\n⚠ | %1 users already have 🌺cxly🌺 whiteList role:\n%2",

			missingIdAdd: "⚠ | Please enter ID or tag user to add in whiteListIds",

			removed: "🐼 | Removed 🫶cxly🌺 whiteList role of %1 users:\n%2",

			notAdmin: "⚠ | %1 users don't have 🌺cxly🫶 whiteListIds role:\n%2",

			missingIdRemove: "⚠ | Please enter ID or tag user to remove whiteListIds",

			listAdmin: "👑 | List of ❤️‍🩹cxly🌺 whiteListIds:\n%1",

      enable: "🌺 Turned 🌺Cxly🌺 Wl on",

      disable: "🐼 Turned 🐼Cxly🐼 wl off"
